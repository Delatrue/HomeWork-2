...
let findProd = document.querySelector(".products");
let findButton = document.querySelectorAll("button");
findButton.forEach(function(button){
...
function showCategory(category) {
    ...
    catProd.forEach(function (product) {
        setProdDiv += getProductMarkup(product);
    });
    findProd.insertAdjacentHTML("afterbegin", setProdDiv);
}
